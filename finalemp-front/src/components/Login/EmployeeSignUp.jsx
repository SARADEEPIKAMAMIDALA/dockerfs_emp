...
//     e.preventDefault()
//     try {
//       const response = await fetch("http://localhost:8080/api/auth/employee/signup", {
//         method: "POST",
...
//         alert(`Sign-up failed: ${errorData.message || 'An error occurred.'}`)
//       }
//     } catch (error) {
...
//     setMessageType(null)
//     try {
//       const response = await fetch("http://localhost:8081/api/auth/employee/signup", {
//         method: "POST",
//         headers: { "Content-Type": "application/json" },
//         body: JSON.stringify(credentials),
//       })
...
const EmployeeSignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setMessageType(null);
    try {
      const response = await fetch("http://localhost:2025/api/auth/employee/signup", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(credentials),
      });
